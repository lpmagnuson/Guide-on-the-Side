  ...
  <div id="scrollable">
      ...
      <div class="step">
        ...
        echo "<p>";
       // echo $this->Html->link('Got a second?  Let us know what you thought of this tutorial (optional).', array('action' => 'provide_feedback',
         // $tutorial['Tutorial']['id']), array('id' => 'provide-feedback'));
        echo "</p>";
        echo "Congratulations on finishing this tutorial! <br /> <br /> If you need assistance with library research, please contact your Butler Librarians or visit the library's website.";
      ?>
      </div>
    </form>
  </div>
